...
abstract class TransactionsMutationRepo {
  Future<dynamic> createOrUpdateTransaction(String token, double amount,
      int brand_id, String created_at, String note);
}
...
class CreateTransactionRepo implements TransactionsMutationRepo {
  ...
  @override
  Future<dynamic> createOrUpdateTransaction(String token, double amount,
      int brand_id, String created_at, String note) async {
    try {
